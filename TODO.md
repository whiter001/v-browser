...
- [x] **P10-9** 统一 SOP、命令参考、技能说明、改进清单的文档串连
- [x] **P10-10** 新用户能按文档快速上手并找到下一步
...
- [x] **P11-5** `packages/extension`：增加单元测试基础设施（vitest 配置 + 基础测试）

---

## 待处理项目

1. **P9-1**: `cdp/types.v` CDP类型定义 - 需要大型重构（暂不处理，影响范围大）
2. **P11-5 完整实现**: extension 需要完整 mock Chrome API 的单元测试（待后续扩展）
